...
const app = x();
Router.route("/").get((r) => r.res.end("Привет мир!"));
Router.route("/err").get((r) =>
  r.res.end('Увы, не получилось! Ещё раз: <a href="/profile">Профиль</a>')
);
app
...
const s = h1(app).listen(process.env.PORT || PORT, () => log(process.pid));
